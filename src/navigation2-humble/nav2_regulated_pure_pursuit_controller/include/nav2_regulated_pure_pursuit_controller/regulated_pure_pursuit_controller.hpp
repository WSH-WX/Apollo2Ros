...
public:
  ...
  double compute(double total_heading_erro) {
    auto current_time = std::chrono::steady_clock::now();
    std::chrono::duration<double> elapsed = current_time - last_time_;
    double dt = elapsed.count();

    double error = total_heading_erro;
    integral_ += error * dt;
...
protected:
   ...
   * @brief 个人添加
   */
  std::vector<double> calculateCurvature(const nav_msgs::msg::Path &global_plan);
  ...
  nav_msgs::msg::Path const_global_plan_;
  double distance_error_;
  double first_curvature_;  // 声明 first_curvature 作为成员变量
  geometry_msgs::msg::PoseStamped previous_carrot_pose_;
  bool first_run_ = true;
  double cur_to_end_point_dis_ = 0.0;
  double match_point_heading;
  double resampling_ds = 0.1;

  nav_msgs::msg::Path resampled_path;  // 用于存储重新采样后的路径

  std::vector<double> velocities_;

  // 重新采样路径的函数声明
  void setResampledPath(const nav_msgs::msg::Path &path);
  ...
  std::vector<double> generateVelocities(const nav_msgs::msg::Path& plan, const std::vector<double>& curvatures);

  // PID Controller instance for heading controls
  PIDController heading_pid_controller_{4.0, 0.45, 0.0};  // Initial values for kp, ki, kd

  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float64>> lookahead_dist_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float64>> tracket_erro_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> curvature_debug_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> xyyaw_control_erro_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> path_cur_yaw_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> PID_erro_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> cur2lookahead_erro_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PoseStamped>> robot_pose_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>> pruned_path_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>> segment_path_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::PoseStamped>> carrot_pose_world_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float64MultiArray>> curvature_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float64MultiArray>> curvature2_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<std_msgs::msg::Float64MultiArray>> velocities_publisher_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<nav_msgs::msg::Path>> resampled_path_publisher_;


  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> segment_plan_path_plotjuggler_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> vehicle_current_pose_plotjuggler_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> lookaheadpoint_pose_plotjuggler_;
  std::shared_ptr<rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>> resampled_plan_path_plotjuggler_;
  //--------------------------------------------------------------------------
