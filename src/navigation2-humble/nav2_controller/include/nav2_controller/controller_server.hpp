...
protected:
  ...
  //---------------------------------------------------------------------
  // nav_msgs::msg::Path global_segment_path_;
  double num_interpolation_points = 50; 
  double dist = 0.5;

  rclcpp_lifecycle::LifecyclePublisher<geometry_msgs::msg::Point>::SharedPtr plan_path_point_pub_;

  bool transformPose2(const std::string frame,const geometry_msgs::msg::PoseStamped & in_pose,
                    geometry_msgs::msg::PoseStamped & out_pose) const;
  bool reachedEndOfSegment(const nav_msgs::msg::Path &path_self,const geometry_msgs::msg::PoseStamped &robot_pose);
  std::vector<nav_msgs::msg::Path> segmentPathByCusp(const nav_msgs::msg::Path &path);
  ...
  void setPlannerPathController(const nav_msgs::msg::Path & path);
