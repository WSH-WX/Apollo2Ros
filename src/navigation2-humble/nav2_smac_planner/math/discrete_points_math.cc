...
bool DiscretePointsMath::ComputePathProfile(
  ...
  if (headings == nullptr) {
    RCLCPP_ERROR(rclcpp::get_logger("SmacPlannerSmoother"), "headings pointer is null");
    throw std::runtime_error("headings pointer is null");
  }
  if (kappas == nullptr) {
      RCLCPP_ERROR(rclcpp::get_logger("SmacPlannerSmoother"), "kappas pointer is null");
      throw std::runtime_error("kappas pointer is null");
  }
  if (dkappas == nullptr) {
      RCLCPP_ERROR(rclcpp::get_logger("SmacPlannerSmoother"), "dkappas pointer is null");
      throw std::runtime_error("dkappas pointer is null");
  }
