...
#     fig, (ax1, ax2,ax3 ) = plt.subplots(2, 1, figsize=(10, 12))
    ...
    #     curvature_temp.append(curvature_values[:, i])
    cusp_xy = []
...
#         axes[2,0].plot(plan_temp[:,2], color='red', label = "path",linewidth=0.5)
...
#     print(f'lookahead_len:{len(x_values3)}')
    ...
    # 保存图片
    plt.savefig("data/0901_PNG/"+save_pic_name+".png")
