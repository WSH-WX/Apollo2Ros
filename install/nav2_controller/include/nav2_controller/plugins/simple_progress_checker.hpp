...
protected:
  ...
  double pose_distance(const geometry_msgs::msg::Pose2D & pose1, const geometry_msgs::msg::Pose2D & pose2);
  ...
  // 声明发布者
  rclcpp::Publisher<geometry_msgs::msg::Point>::SharedPtr track_erro_pub_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr control_timestamp_;
  rclcpp::Publisher<std_msgs::msg::Float64>::SharedPtr diff_timestamp_;
